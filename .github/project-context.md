...
## What This Is
An in-game guidebook for the [Croptopia](https://modrinth.com/mod/croptopia) mod,
built using the Handbook library. Provides an up-to-date reference for Croptopia
recipes, crops, and trees. No external dependencies bundled — all content is in the
mod itself.
